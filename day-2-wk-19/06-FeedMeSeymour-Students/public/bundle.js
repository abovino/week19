...
/***/ function(module, exports, __webpack_require__) {
	...
	var Seymour = __webpack_require__(159);

	// This code here allows us to render our main component (in this case "Seymour")
	ReactDOM.render(React.createElement(Seymour, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Child1 = __webpack_require__(160);
	var Child2 = __webpack_require__(161);
	var Child3 = __webpack_require__(162);
	...
	var Seymour = React.createClass({
		...
		feedSeymour: function feedSeymour(food) {
			this.setState({
		...
		componentDidUpdate: function componentDidUpdate() {
			/* TODO alert when the consumed state is greater than 500 */
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'em',
								null,
								'Click on Seymour\'s Children to Feed Him'
							)
						)
					),
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement('img', { src: 'https://media.giphy.com/media/pBj0EoGSYjGms/giphy.gif' })
							)
						)
					),
					React.createElement(
						'div',
						{ className: 'col-md-4' },
						React.createElement(Child1, { feedSeymour: this.feedSeymour })
					),
					React.createElement(
						'div',
						{ className: 'col-md-4' },
						React.createElement(Child2, { feedSeymour: this.feedSeymour })
					),
					React.createElement(
						'div',
						{ className: 'col-md-4' },
						React.createElement(Child3, { feedSeymour: this.feedSeymour })
					)
				)
			);
		}
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement("img", { src: "http://www.toxel.com/wp-content/uploads/2011/10/fear08.jpg", width: "100%", onClick: this.handleClick })
				)
			);
		}
	});
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement("img", { src: "http://www.cellphonetaskforce.org/wp-content/uploads/2012/01/frog-left.jpg", width: "100%", onClick: this.handleClick })
				)
			);
		}
	});
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement("img", { src: "http://afcsoyfoods.com/media/2014/02/afc-organic-tofu-firm-14oz.png", width: "100%", onClick: this.handleClick })
				)
			);
		}
	});
